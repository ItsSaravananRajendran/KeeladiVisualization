...
const Content = props => {
    ...
    return <div ref={nodeRef} className={Style.container}>
        ...
        <Map className={Style.map1} height={625} width="100%" />
        <Title>Vaigai River Valley</Title>
        <TextAndMap
            text="It serves as one of the major culture zones of tamilnadu. The entire Vaigai river valley having a length of 260 km from its origin in the
Veḷḷimalai in the west and its confluence with Bay of Bengal in the east and covering 10,580
 sq.km area extending upto 20 km on either side of the river banks is taken up for intensive investigations to understand the cultural process through the ages."
        />
        <Text>
